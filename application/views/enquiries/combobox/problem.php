                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 float-left">
                                <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>problem_c/add_problem" role="button" aria-expanded="false" aria-controls="collapseExample">
                                    Tambah
                                </a>
                            ...
                            <div class="col-md-5">
                                <div>
                                    <?php echo form_open(base_url() . "problem_c/index"); ?>
                        ...
                        <table id="example2" class="table table-hover mt-3">
                            ...
                            <tbody>
                                ...
                                foreach ($problems as $problem) {
                                    ...
                                    ?>
                                    <tr class="row">
                                        <td class="col-1"><?php echo $problem->id; ?></td>
                                        <td class="col-5"><?php echo $problem->name; ?></td>
                                        <td><?php echo anchor(base_url() . "problem_c/detail/" . $problem->id, '<div class="btn btn-success btn-sm m-1">
                        <i class="fa fa-search-plus"></i>
                      </div>');
                                                                echo anchor(base_url() . "problem_c/edit/" . $problem->id, '<div class="btn btn-danger btn-sm m-1">
